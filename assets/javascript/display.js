$(document).ready(function() {//Sniff around for scope conflicts and issues. They can't hide forever...
	    ...
	    */
		...
		$("#submit-button").on("click", function() {
			...
			$("#main-page").fadeIn("fast", function() {
		    	var params = {
		    		//I assume we need API data inserted into this object?
		    	};
	...
	/*};//end doDiplay(). But why doesn't the front curly bracket highlight w/ its mate?*/
});//end $(document).ready. But why doesn't the front curly bracket highlight w/ its mate?
